...
value	('Trung Cấp'),
		...
		('Đại Học '),
		('Sau Đại Học');
-- data employee partscode_employee--
...
-- data employee
insert into employee(name_employee,date_of_birth,
					idcard,salary,phone
					,email,address,id_position,id_qualification,id_partscode)
values 	('Nguyễn Văn An','1970-11-07','456231786',10000000,'0901234121','annguyen@gmail.com','295 Nguyễn Tất Thành, Đà Nẵng',1,3,1),
        ...
        select*from partscode_employee;
...
-- data customers 
insert into customer(name_customer,date_of_birth
					,gender,card_id_customer,phone,email,address,id_type_customer)
...
-- data service rentals tail --
insert into rental_type_service(name_rental_type)
value	('Year'),
		('Month'),
		('Day'),
		('Hour');
select * from rental_type_service;
...
insert into service_furama(name_service,usable_area,rental_cost,number_person
					,room_standards,description_facility,pool_area,floor
                    ,id_rental_type,id_type_service)
...
select * from service_furama;

-- contract
-- data contract accompanying_services --
...
-- data contract --
insert into contract(date_start_contract,date_end_contract,deposit,
					id_employee,id_customer,id_service)
