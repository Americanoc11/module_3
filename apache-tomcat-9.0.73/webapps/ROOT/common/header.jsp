    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link color-white" href="#" tabindex="-1">
                        Kinh nghiệm
                    </a>
                </li>
            </ul>
            <form action="/home" class="form-search-header d-flex">
                <button type="submit" class="search-btn btn btn-outline-success me-2">
                    <i class="fa-solid fa-magnifying-glass">
                    </i>
                </button>
                <input type="search" name="search" id="search" placeholder="search..."
                       class="form-control me-2" value="${nameTitle}">
                <input type="hidden" name="action" value="search">
            </form>
            <div class="account-user" style="margin-right: 150px;">
                <div class="dropdown">
                    <button class="dropdown-toggle col-6" data-bs-toggle="dropdown"
                            aria-expanded="false"
